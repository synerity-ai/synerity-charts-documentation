      ...
      <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="mb-8">
          <div class="flex items-center justify-between">
            <div>
              <h1 class="text-3xl font-bold text-neutral-900 mb-2">Heatmap</h1>
              <p class="text-lg text-neutral-600">
                Interactive heatmap component with comprehensive customization options and data visualization.
              </p>
            </div>
          ...
          <nav class="flex space-x-8 border-b border-neutral-200">
            <button
              ...
              [class]="activeTab === 'demo' 
                ? 'border-b-2 border-red-500 text-red-600 px-1 py-4 text-sm font-medium' 
        ...
        <div class="tab-content">
          ...
          <div *ngIf="activeTab === 'demo'" class="animate-fade-in">
            <app-heatmap-chart-demo></app-heatmap-chart-demo>
          </div>
            ...
            <div class="space-y-8">
              ...
              <div class="bg-white rounded-lg border border-neutral-200 p-8">
                <div class="flex items-center mb-6">
                  ...
                  <div>
                    <h2 class="text-2xl font-bold text-neutral-900">Heatmap Documentation</h2>
                ...
                <div class="space-y-6">
                  ...
                  <div class="bg-neutral-50 rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                      <div>
                        <code class="text-sm bg-neutral-200 px-2 py-1 rounded">data: HeatmapData[]</code>
                        <p class="text-sm text-neutral-600 mt-1">Array of heatmap data points</p>
                      </div>
                      <div>
                        <code class="text-sm bg-neutral-200 px-2 py-1 rounded">config: HeatmapConfig</code>
                        <p class="text-sm text-neutral-600 mt-1">Configuration object for the heatmap</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="bg-neutral-50 rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                      <div>
                        <code class="text-sm bg-neutral-200 px-2 py-1 rounded">Color Scales</code>
                        <p class="text-sm text-neutral-600 mt-1">Customizable color scales for data visualization</p>
                      </div>
                      <div>
                        <code class="text-sm bg-neutral-200 px-2 py-1 rounded">Interactive Cells</code>
                        <p class="text-sm text-neutral-600 mt-1">Click and hover interactions on heatmap cells</p>
                      </div>
                      <div>
                        <code class="text-sm bg-neutral-200 px-2 py-1 rounded">Value Display</code>
                        <p class="text-sm text-neutral-600 mt-1">Optional value display within cells</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div *ngIf="activeTab === 'how-to-use'" class="animate-fade-in">
            <div class="space-y-8">
              <div class="bg-white rounded-lg border border-neutral-200 p-8">
                <h2 class="text-2xl font-bold text-neutral-900 mb-6">How To Use Heatmap</h2>
                ...
                <div class="space-y-6">
                  ...
                  <div>
                    ...
                    <div class="bg-neutral-50 rounded-lg p-4">
                      <p class="text-sm text-neutral-600">Import the HeatmapChartModule in your Angular module.</p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="bg-neutral-50 rounded-lg p-4">
                      <p class="text-sm text-neutral-600">Use the app-heatmap-chart component with data and configuration.</p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="bg-neutral-50 rounded-lg p-4">
                      <p class="text-sm text-neutral-600">Configure color scales, cell styling, and interactive features.</p>
                    </div>
                  </div>
                </div>
              </div>
