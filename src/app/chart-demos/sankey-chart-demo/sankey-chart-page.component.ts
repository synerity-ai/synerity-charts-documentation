      ...
      <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="mb-8">
          <div class="flex items-center justify-between">
            <div>
              <h1 class="text-3xl font-bold text-neutral-900 mb-2">Sankey Diagram</h1>
              <p class="text-lg text-neutral-600">
                Interactive Sankey diagram component with comprehensive customization options and flow visualization.
              </p>
            </div>
          ...
          <nav class="flex space-x-8 border-b border-neutral-200">
            <button
              ...
              [class]="activeTab === 'demo' 
                ? 'border-b-2 border-cyan-500 text-cyan-600 px-1 py-4 text-sm font-medium' 
        ...
        <div class="tab-content">
          ...
          <div *ngIf="activeTab === 'demo'" class="animate-fade-in">
            <app-sankey-chart-demo></app-sankey-chart-demo>
          </div>
            ...
            <div class="space-y-8">
              ...
              <div class="bg-white rounded-lg border border-neutral-200 p-8">
                <div class="flex items-center mb-6">
                  ...
                  <div>
                    <h2 class="text-2xl font-bold text-neutral-900">Sankey Diagram Documentation</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div class="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-lg p-6">
                    <div class="w-8 h-8 bg-cyan-500 rounded-lg flex items-center justify-center mb-3">
                ...
                <div class="space-y-6">
                  ...
                  <div class="bg-neutral-50 rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                      <div>
                        <code class="text-sm bg-neutral-200 px-2 py-1 rounded">data: SankeyData</code>
                        <p class="text-sm text-neutral-600 mt-1">Sankey diagram data with nodes and links</p>
                      </div>
                      <div>
                        <code class="text-sm bg-neutral-200 px-2 py-1 rounded">config: SankeyConfig</code>
                        <p class="text-sm text-neutral-600 mt-1">Configuration object for the Sankey diagram</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="bg-neutral-50 rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                      <div>
                        <code class="text-sm bg-neutral-200 px-2 py-1 rounded">Flow Visualization</code>
                        <p class="text-sm text-neutral-600 mt-1">Visual representation of flow between nodes</p>
                      </div>
                      <div>
                        <code class="text-sm bg-neutral-200 px-2 py-1 rounded">Interactive Nodes</code>
                        <p class="text-sm text-neutral-600 mt-1">Click and hover interactions on nodes and links</p>
                      </div>
                      <div>
                        <code class="text-sm bg-neutral-200 px-2 py-1 rounded">Customizable Styling</code>
                        <p class="text-sm text-neutral-600 mt-1">Node width, padding, and link opacity customization</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div *ngIf="activeTab === 'how-to-use'" class="animate-fade-in">
            <div class="space-y-8">
              <div class="bg-white rounded-lg border border-neutral-200 p-8">
                <h2 class="text-2xl font-bold text-neutral-900 mb-6">How To Use Sankey Diagram</h2>
                ...
                <div class="space-y-6">
                  ...
                  <div>
                    ...
                    <div class="bg-neutral-50 rounded-lg p-4">
                      <p class="text-sm text-neutral-600">Import the SankeyChartModule in your Angular module.</p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="bg-neutral-50 rounded-lg p-4">
                      <p class="text-sm text-neutral-600">Use the app-sankey-chart component with flow data and configuration.</p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="bg-neutral-50 rounded-lg p-4">
                      <p class="text-sm text-neutral-600">Configure node layout, link styling, and interactive features.</p>
                    </div>
                  </div>
                </div>
              </div>
